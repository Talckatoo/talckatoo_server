...
const { getConversations, getConversation, getMessages, getMessage, createMessage, editMessage, deleteMessage, createVoiceNote, deleteVoiceNote, createVoiceTranslate, } = require("../controllers/message-controller");
/**
 * @swagger
 * /conversations:
 *   get:
